...
<div class="container-fluid content">
    ...
    <div class="row">
        ...
        <div class="main sidebar-minified">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-table"></i>出库管理</h3>
                    <ol class="breadcrumb">
                        <li><a href="/index.jsp"><i class="fa fa-home"></i>首页</a></li>
                        <li><i class="fa fa-table"></i>出库管理</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h2><i class="fa fa-table red"></i><span class="break"></span><strong>出库信息列表</strong></h2>
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered">
                            ...
                            <s:iterator var="fai" value="#session.findAllOutstorage">
                                <tr>
                                    <td><s:property value="#fai.outstorageId"/></td>
