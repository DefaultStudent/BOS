        ...
        <div class="sidebar-menu">
            <ul class="nav nav-sidebar">
                ...
                <s:if test="#session.loginUser.role == 0">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-truck"></i><span class="text"> 入库管理</span> <span class="fa fa-angle-down pull-right"></span></a>
                        <ul class="nav sub">
                            <li><a href="findAllInstorage.action"><i class="fa fa-list"></i><span class="text"> 入库信息概览</span></a></li>
                            <li><a href="findAllSupplier_Ins.action"><i class="fa fa-ambulance"></i><span class="text"> 入库信息添加</span></a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-file-text"></i><span class="text"> 出库管理</span> <span class="fa fa-angle-down pull-right"></span></a>
                        <ul class="nav sub">
                            <li><a href="findAllOutstorage.action"><i class="fa fa-hdd-o"></i><span class="text"> 出库信息概览</span></a></li>
                ...
                <s:elseif test="#session.loginUser.role == 1">
                    <li>
                        <a href="#"><i class="fa fa-file-text"></i><span class="text"> 仓库管理</span> <span class="fa fa-angle-down pull-right"></span></a>
                        <ul class="nav sub">
                            <li><a href="findAllStorage.action"><i class="fa fa-hdd-o"></i><span class="text"> 仓库信息概览</span></a></li>
